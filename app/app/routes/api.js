 ...
 router.post('/active', function(req, res) {
   ...
   router.post('/authenticate', function(req, res) {
        ...
        if(id != null){
            ...
            //   var token = jwt.sign({ username:email, email: email,  }, secret, { expiresIn: '24h' }); // Logged in: Give user token
    ...
    router.get('/permission', function(req, res) {
        ...
        if(permission != null){
            ...
            res.json({ success: true, permission: permission }); // Return the user's permission
